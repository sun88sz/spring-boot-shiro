...
@ConfigurationProperties(locations = "classpath:datasource.yml", prefix = "spring.datasource")
public class DruidDataSourceProperties implements BeanClassLoaderAware, EnvironmentAware, InitializingBean {
	...
	/**
	 * Allows the DataSource to be managed by the container and obtained via
	 * JNDI. The {@code URL}, {@code driverClassName}, {@code username} and
