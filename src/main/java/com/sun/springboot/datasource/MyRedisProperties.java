...
@ConfigurationProperties(prefix = "spring.redis-2")
public class MyRedisProperties {
	...
	public static class Cluster {
		...
		/**
		 * Comma-separated list of "host:port" pairs to bootstrap from. This
		 * represents an "initial" list of cluster nodes and is required to have
		 * at least one entry.
		 */
		private List<String> nodes;

		/**
		 * Maximum number of redirects to follow when executing commands across
		 * the cluster.
		 */
